...
int ledPins[] = {5, 9, 10};  //array with all the LED's pins
int ledStates[] ={0, 0, 0};  //this means the LED's states at first is 0 = LOW
...
void setup(){
  ...
  Serial.println("10-4 Good Buddy");
...
void loop(){
  ...
  if (irrecv.decode(&results)){
   ...
   switch (results.value){
      case 16761405: //when you press the Forward button
      ...
      case 16712445: //when you press the Reverse button
      ...
      case 16769565: //when you press the Mute button
      ...
      case 16753245: //when you press the Power button
