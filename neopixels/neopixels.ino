...
void setup () {
  ...
  // startup sequence
  delay(500);
  colorWipe(hour_circle.Color(255, 0, 0), 20); // Redhour_circle
  colorWipe(hour_circle.Color(0, 255, 0), 20); // Green
  colorWipe(hour_circle.Color(0, 0, 255), 20); // Blue
  delay(500);
...
void loop () {
  ...
  minute_pix = (minuteval % 15);
  second_pix = (secondval % 15);
